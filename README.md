...
[**YEJI — Fortune LLM**](https://github.com/yeji-service) · Qwen3 v1~v9 파인튜닝 → AWQ 양자화 **-65%** → vLLM 프로덕션 서빙
<br>
`FastAPI` `vLLM` `Qwen3` `Spring Boot` `Jenkins`

[**Speaki — AI Character**](https://github.com/tellang/speaki) · SFT + DPO + SimPO 3단계 정렬 → 6캐릭터 페르소나 **4.12/5.00**
<br>
`FastAPI` `vllm-mlx` `EXAONE` `Redis`

[**MyEat**](https://github.com/yumyum-labs) <img src="https://img.shields.io/badge/우수상-FF6B35?style=flat-square" /> · Redis Vector Search 2단계 RAG · **180K+** 음식 DB · API 비용 **-50%**
<br>
`Java 17` `Spring Boot` `Redis Stack` `GPT-5 Mini`

[**triflux**](https://github.com/tellang/triflux) · 멀티 모델 CLI 오케스트레이터 · Claude × Codex × Gemini
<br>
`TypeScript` `Node.js` `LLM API` <img src="https://img.shields.io/github/stars/tellang/triflux?style=flat-square&color=A78BFA&labelColor=1F222E" />
